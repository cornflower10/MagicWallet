...
//                                                @Part("creditLine") RequestBody creditLine,
    ...
    Observable<BaseEntity<Loan>> LoanOrderList(@Field("pageNumber") int pageNumber
     ...
     */
    @FormUrlEncoded
    @POST("member/order/delete")
    Observable<BaseEntity<String>> DeleteLoanOrder(@Field("id") long id);
